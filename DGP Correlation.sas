...
*ODS OUTPUT fitstatistics=stockage;
proc glmselect data = tableau outdesign=names plots=all; 
model Y= X1-X50 ; /*details=all */; /*performance details;*/
run;
